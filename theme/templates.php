...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 9999988888</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> efashion@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
				<iframe width="853" height="480" src="https://www.youtube.com/embed/o91f2wmpJRQ"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <!--    <iframe class="iframe-img"  src="https://www.youtube.com/watch?v=o91f2wmpJRQ"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                </a> 
              </div>
            </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Developed by <span><a href="#">VDV</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="#">E Fashion</a></span></p>
        </div>
      </div>
    </div>
